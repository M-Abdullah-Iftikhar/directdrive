          ...
          <h1>Direct Drive</h1>
            ...
            <div class="menu">
                <ul>
                    ...
                    <li class="menu_items"><a href="">Booking</a></li>
                    <li class="menu_items"><a href="">Contact us</a></li>
                    <li class="menu_items"><a href="login.php">Log in</a></li>
                    <li class="menu_items"><a href="signup.php">Sign up</a></li>
                </ul>
            </div>
        </div>
    </nav>
